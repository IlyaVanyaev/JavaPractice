...
public class Drunk {
    ...
    public Drunk(String fp, String sp) {
        this.fp = new Stack<>();
        this.sp = new Stack<>();
        for (int i = 4; i >= 0; i--) {
    ...
    public static void main(String[] args) {
        System.out.println(new Drunk("56327", "98345").play());
        System.out.println(new Drunk("54321", "09876").play());
        System.out.println(new Drunk("03875", "26703").play());
    }
}